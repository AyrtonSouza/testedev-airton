...
INSERT INTO producao.artesao (   id,   cpf,   data_cadastro,   nome,   situacao,   id_municipio,   id_atendimento,   via_carteira,   cep,   endereco_complemento,   data_expedicao_rg,   data_nascimento,   email,   endereco,   endereco_numero,   imigrante_br,   nome_mae,   nome_pai,   numero_identidade,   orgao_expedidor,   posicao_familiar,   posicao_familiar_especifica,   rede_social,   telefone_celular,   telefone_fixo,   uf,   zona_urbana,   naturalidade_id,   nacionalidade_id,   estado_identidade_id,   bairro_id,   distrito_id,   estado_id,   local_vive,   situacao_especial,   etnia,   registro_funai,   contribui_previdencia,   cor_raca,   dependentes_economicos,   escolaridade,   estado_civil,   moradia,   possui_deficiencia,   renda_familiar,   renda_individual,   sexo,   maior_fonte_renda,   artesao_desde,   instrutor_tecnica,   motivo_ingresso_artesanal,   status_atividade,   vinculo_grupo,   qnt_horas_producao,   local_producao,   sistema_trabalho,   destino_producao,   forma_pagamento,   maior_cliente,   tipo_venda,   numero_carteira,   data_validade_carteira ) VALUES (   56898,   '708.671.680-48',   '2019-03-20',   'Lima Oliveira',   0,   2,   1,   1,   '62870-000',   'Rua 0125',   '2011-01-20',   '1950-02-15',   'teste_@gmail.com',   'Rua 201 Teste',   '256',   false,   'Silva Rita de Souza',   'Juca de Oliveira Lima',   '123123456',   'ssp',   1,   'Lider',   'juca_',   '99245-5263',   '3482565',   'MA',   false,   1,   1,   1,   2,   2,   2,   1,   0,   'Outro',   'teste teste teste',   false,   2,   false,   4,   0,   2,   false,   2,   3,   0,   1,   0,   true,   0,   0,   false,   2,   1,   1,   0,   0,   0,   3,    258565,   '2021-04-04' );
...
INSERT INTO producao.historico_produto_artesanal (   id,   valor_compra,   id_produto_artesanal,   data_atualizacao,   usuario_responsavel ) VALUES (   1,   10,   1,   '2019-04-17',   1 );
INSERT INTO producao.historico_produto_artesanal (   id,   valor_compra,   id_produto_artesanal,   data_atualizacao,   usuario_responsavel ) VALUES (   2,   10,   1,   '2019-04-18',   1 );

INSERT INTO producao.motivo_reajuste (   id,   motivo_reajuste,   ativo ) VALUES (   1,   'TESTE',   true );
